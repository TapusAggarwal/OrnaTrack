...
Public Class PreviewKitty
    ...
    Private Sub PreviewKitty_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim pnl As Panel = CoustProfileUpdated.ProfilePanel
        pnl.Dock = DockStyle.Fill
        pnl.BackColor = Color.FromArgb(36, 30, 60)
        Panel1.Controls.Add(pnl)
        LoadComboBoxData(CoustProfileUpdated.ProfessionCB, Customer.ListOfProfessions)
        LoadComboBoxData(CoustProfileUpdated.RegionCB, Customer.ListOfRegions)
        CoustProfileUpdated.LoadProfileData(_customer:=_kitty.Owner)
        ShowKittyForm()
    End Sub
    ...
    Private Sub SaveCoustmerButton_Click(sender As Object, e As EventArgs) Handles SaveCoustmerButton.Click
        ...
        If CoustProfileUpdated.NameTB.TextLength = 0 Then
