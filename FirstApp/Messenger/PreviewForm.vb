...
Public Class PreviewForm
    ...
    Private CurrentControlsValue As Integer = 0
    ...
    Public Async Function SendMessage(phno As String, _kitty As Kitty) As Task(Of String)
        Dim MessageList As List(Of String) = MessageText.Split($"{Environment.NewLine}{Environment.NewLine}<Next Message>{Environment.NewLine}{Environment.NewLine}").ToList
